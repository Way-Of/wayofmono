 ...
 * Encodes cwd into a safe directory name under ~/.wo/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.wo/agent/sessions/<encoded-cwd>/).
	 */

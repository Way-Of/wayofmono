...
// Append skills section (only if read tool is available)
	...
	let prompt = `You are an expert coding assistant operating inside wocode, a coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.

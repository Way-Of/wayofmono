...
import { Container, Image, Spacer, Text } from "@wayofmono/wo-tui";
import { getBundledInteractiveAssetPath } from "../../../config.js";
import { theme } from "../theme/theme.js";
import { DynamicBorder } from "./dynamic-border.js";

const BLOG_URL = "https://github.com/Way-Of/wayofmono";
...
export class EarendilAnnouncementComponent extends Container {
	constructor() {
		...
		this.addChild(new Text(theme.bold(theme.fg("accent", "wocode has joined WayOfMono")), 1, 0));

...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@wayofmono/wo-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@wayofmono/wo-coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown wocode and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what wo loaded without re-discovering resources. */
...
export interface ExtensionAPI {
	 ...
	 * wocode.registerProvider("my-proxy", {
	 ...
	 * wocode.registerProvider("anthropic", {
	 *   baseUrl: "https://proxy.example.com"
	 * });
	 *
	 * @example
	 * // Register provider with OAuth support
	 * wocode.registerProvider("corporate-ai", {
	 ...
	 *
	 * @example
	 * wocode.unregisterProvider("my-proxy");
	 */
...
/** Configuration for registering a provider via wocode.registerProvider(). */
...
export interface ProviderModelConfig {
	...
	reasoning: boolean;
	/** Maps wocode thinking levels to provider/model-specific values; null marks a level unsupported. */
...
export type ExtensionFactory = (wo: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for wocode.* API methods.

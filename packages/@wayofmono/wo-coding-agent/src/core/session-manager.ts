import { type AgentMessage, uuidv7 } from "@wayofmono/wo-agent-core";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if wocode-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if wocode-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.wocode/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.wocode/agent/sessions/<encoded-cwd>/).
	 */

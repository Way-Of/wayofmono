    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="wo-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="wo-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'wo-share:v1:sidebar-width';

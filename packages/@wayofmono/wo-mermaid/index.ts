import type { ExtensionAPI, ExtensionContext, MessageRenderer, SessionEntry } from "@wayofmono/wo-coding-agent";
import { getMarkdownTheme, keyHint } from "@wayofmono/wo-coding-agent";
import { Box, Spacer, Text, type Component, truncateToWidth, visibleWidth } from "@wayofmono/wo-tui";

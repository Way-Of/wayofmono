...
> [!NOTE]
> This reference guide is based on the official [Antigravity/Gemini Subagents Documentation](https://antigravity.google/docs/subagents).
...
### Built-In Subagents
Antigravity / Gemini CLI comes pre-packaged with several specialized subagents:
...
Antigravity 2.0 / Gemini CLI introduces advanced multi-agent orchestration for extremely complex tasks.

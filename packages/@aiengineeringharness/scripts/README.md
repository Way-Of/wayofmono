...
4. **Naming convention enforcement**: Pi, OpenCode, and Wo Coder use kebab-case; all others use snake_case enforced by cleanup scripts and compliance checks ensuring uniform expectations upheld globally regardless temporal location boundaries

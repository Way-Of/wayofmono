...
This skill guides the creation of new skills tailored for the Way of Work (WoW) platform. It provides specialized knowledge, templates, and best practices to ensure that newly developed skills align with WoW's architectural mandates, such as multi-tenancy, access control, and Human-in-the-Loop (HITL) requirements.
...
Instructions on how to correctly package and install new WoW skills within the environment, ensuring they are discoverable and usable by the agent.

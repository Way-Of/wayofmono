// Auto-generated from canonical skill: observability_driven_development
...
export const skill = {
  ...
  description: ">",
  tools: ["read_file", "run_shell_command", "glob", "write_file", "replace"],
  prompt: `> **Platform**: Wo Coder | **Skill**: observability_driven_development | **Version**: 1.0.0
>

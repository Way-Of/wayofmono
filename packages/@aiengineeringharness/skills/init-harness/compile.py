#!/usr/bin/env python3
"""Compile init-harness SKILL.md for all 7 AI coding tools.
...
def validate_tool(tool_name, config, body):
    """Check that existing SKILL.md files match what would be generated."""
    frontmatter = build_frontmatter(config)
...
def main():
    parser = argparse.ArgumentParser(description="Compile init-harness SKILL.md for all tools")

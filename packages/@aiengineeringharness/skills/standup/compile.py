#!/usr/bin/env python3
"""Compile standup SKILL.md for all 7 AI coding tools.
...
CANONICAL_DESCRIPTION = (
    "Generate daily end-of-day standup entries and save them to the shared "
    "f-rr-d thoughts repository at thoughts/global/standup/<dev>/<YYYY-MM-DD>.md. "
    "Detects developer identity, prompts for work details, blockers, and metrics, "
    "then commits and pushes the entry to f-rr-d."
)
...
def main():
    parser = argparse.ArgumentParser(description="Compile standup SKILL.md for all tools")

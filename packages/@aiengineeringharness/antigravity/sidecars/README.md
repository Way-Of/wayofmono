...
> [!NOTE]
> This reference guide is based on the official [Antigravity Sidecars Documentation](https://antigravity.google/docs/sidecars).
...
Sidecars can use the `agentapi` CLI to programmatically interact with Antigravity. The executable is automatically added to the sidecar’s `PATH`.

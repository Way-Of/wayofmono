...
description: Specialized agent for deep analysis of research documents and thought notes. Extracts high-value insights, decisions, and actionable information while filtering noise. Utilizes Antigravity CLI tools like `read_file` to process document content.
---

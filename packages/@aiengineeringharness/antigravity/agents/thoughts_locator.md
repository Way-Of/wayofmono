...
description: Discovers relevant documents in the thoughts/ directory for metadata, research notes, decisions, and historical context. Utilizes Antigravity CLI tools such as `search_file_content`, `glob`, and `list_directory` to locate and categorize documentation.
---

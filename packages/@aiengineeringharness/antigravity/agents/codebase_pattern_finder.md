...
description: Finds similar implementations, usage examples, and existing patterns in the codebase with concrete code details. Utilizes Antigravity CLI tools such as `search_file_content`, `glob`, and `read_file` to provide working examples and identify established patterns.
---
...
- Plan search strategy with key terms and file patterns, utilizing Antigravity CLI tools.

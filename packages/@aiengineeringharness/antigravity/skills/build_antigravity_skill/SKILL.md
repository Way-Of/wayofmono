...
description: >-
  Antigravity skills expert — knows SKILL.md format, frontmatter fields,
  directory structure, validation rules, and skill command registration. Use
  when the user wants to create or modify Antigravity skills.

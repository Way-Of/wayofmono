...
description: Creates well-structured git commits by analyzing changes, drafting messages, and executing commits using Antigravity CLI's `command` for git operations.
...
- **NEVER add "Generated with Antigravity" or similar messages**

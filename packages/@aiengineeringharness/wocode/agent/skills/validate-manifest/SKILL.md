...
| Wo Coder | `packages/@aiengineeringharness/wocode/agent/` | `*.md` (skills, agents), `*.ts` (extensions) |
...
[ERROR] Missing: wocode/agent/extensions/open-editor.ts
```
...
```
[WARN] Stale: packages/@aiengineeringharness/wocode/agent/skills/temp-skill.md
...
```
[ERROR] Invalid path: wocode/agent/skills//double-slash.md
...
1. `packages/@aiengineeringharness/wocode/agent/skills/validate-manifest/SKILL.md`
...
chmod +x packages/@aiengineeringharness/wocode/agent/skills/validate-manifest/SKILL.md
```

#!/usr/bin/env python3
"""
Antigravity CLI Skill Updater — antigravity/skills
...
Ensures all skills use correct:
  ...
  - Frontmatter fields: name, description, allowed-tools, namespace, platforms

Usage:
    python3 scripts/antigravity-skill-update.py --validate
    python3 scripts/antigravity-skill-update.py --fix
    python3 scripts/antigravity-skill-update.py --add <name> --desc "..."
    python3 scripts/antigravity-skill-update.py --sync-yaml
    python3 scripts/antigravity-skill-update.py --all
"""

import os, sys, re, json, yaml

REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SKILL_DIR = os.path.join(REPO_ROOT, "antigravity/skills")
CONFIG_YAML = os.path.join(REPO_ROOT, "config-manifest/tools/antigravity.yaml")
...
SUPPORTED_FIELDS = ['name', 'description', 'allowed-tools', 'namespace', 'platforms']
HAS_COMMANDS = True
...
def print_help():
    print("Antigravity CLI Skill Updater")
    print("Usage:")
    print(f"  python3 scripts/antigravity-skill-update.py --validate    Validate all skills")
    print(f"  python3 scripts/antigravity-skill-update.py --fix         Auto-fix issues")
    print(f"  python3 scripts/antigravity-skill-update.py --add NAME    Scaffold new skill")
    print(f"  python3 scripts/antigravity-skill-update.py --sync-yaml   Sync YAML config")
    print(f"  python3 scripts/antigravity-skill-update.py --all         Fix + sync-yaml")

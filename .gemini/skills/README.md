...
> [!NOTE]
> This reference guide is based on the official [Antigravity/Gemini Skills Documentation](https://antigravity.google/docs/skills).
...
Gemini automatically discovers skills by looking in two main locations:

1. **Global Skills**: Located under `~/.gemini/config/skills/<skill-folder>/`
   - These are available across all project workspaces and are useful for global utilities and personal preferences.
